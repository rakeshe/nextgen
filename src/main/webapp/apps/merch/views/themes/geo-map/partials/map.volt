 <div class="row">
	<div id="banner_image" class="">
        <div class="img-responsive hidden-xs hidden-sm">
            <div id="bannerFlow"></div><iframe src="//html5.host.bannerflow.com/ad_631424_178.html" style="border:0;width:100%;height:82px;" scrolling="no" frameborder="0" ></iframe>
        </div>
...
<div class="regions_scroll"><div class="display_regions" class="col-sm-4 col-lg-4"></div></div>
	...
	<div class="banner_default_map"><img src="/n/themes/common/img/ajax-loader.gif"/></div>
