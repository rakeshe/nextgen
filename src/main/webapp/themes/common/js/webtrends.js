// WebTrends SmartSource Data Collector Tag v@@TAGVERSION@@
// Copyright (c) @@CURRENTYEAR@@ Webtrends Inc.  All rights reserved.
// Tag Builder Version: @@TBVERSION@@
// Created: @@DATE@@
(function (_window, _document, _navigator, _location) {
	...
	Webtrends.dcs.prototype = {
		init: function (config) {
			...
			if( _window["webtrendsAsyncLoad"] && typeof _window["webtrendsAsyncLoad"] === "function" )
