...
#==============================================================================================================================================
class regionHotelDeals{
	public function fetchRegionVal($arrRegion){		
		foreach($arrRegion as $countryKey=>$countries){
...
$arrRegion = $arrHotelDeals[campaign][Pazifik];//short listing only the region values
$objRegHotelDeal = new regionHotelDeals();//creating a new object
$arrSortValue = $objRegHotelDeal->fetchRegionVal($arrRegion);//creating a new object

//final output
echo '<table border="1" cellpadding="3" cellspacig="3" width="100%"><tr>';
echo '<td valign="top" width="50%"><center>----------------Sorted Region Result--------------------</center>';
echo '<pre>';print_r($arrSortValue);echo '</pre></td>';
echo '<td valign="top" width="50%"><center>----------------RAW JSON Result--------------------</center>';
echo '<pre>';print_r($arrRegion);echo '</pre></td>';
echo '</tr></table>';
?>