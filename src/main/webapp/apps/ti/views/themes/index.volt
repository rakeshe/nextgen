...
<head>
    <meta charset="utf-8">
    {{ get_title() }}
    {{ stylesheet_link("//yui.yahooapis.com/2.9.0/build/reset-fonts-grids/reset-fonts-grids.css",false) }}
    {{ stylesheet_link("//ajax.googleapis.com/ajax/libs/jqueryui/1.10.3/themes/blitzer/jquery-ui.min.css", false) }}
    {{ stylesheet_link("//maxcdn.bootstrapcdn.com/bootstrap/3.2.0/css/bootstrap.min.css",false) }}
...
{{ javascript_include("//maxcdn.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js", false) }}
