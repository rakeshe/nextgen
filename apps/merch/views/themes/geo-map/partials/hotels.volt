				...
				<div class="legend"> Room {{ i }} </div>
                    <div class="guests" style="width: 100%;">
                        ...
                        <div class="row search_childTravelers noneBlock">
                            ...
                            <div id="search_ChildLabel2Room{{ i }}" style="padding:5px 0px 0px 5px;" class="col-lg-1 control select noneInlineBlock custom js-select">
                            ...
                            <div id="search_ChildLabel3Room{{ i }}"  style="padding:5px 0px 0px 5px;" class="col-lg-1 control select noneInlineBlock custom js-select">
                            ...
                            <div id="search_ChildLabel4Room{{ i }}" style="padding:5px 0px 0px 5px;" class="col-lg-1 control select noneInlineBlock custom js-select">
                            ...
                            <div id="search_ChildLabel5Room{{ i }}" style="padding:5px 0px 0px 5px;" class="col-lg-1 control select noneInlineBlock custom js-select">
