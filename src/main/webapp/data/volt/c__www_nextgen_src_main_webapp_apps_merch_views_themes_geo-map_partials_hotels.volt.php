...
<!-- Hotel List -->
	...
	<div class="search_footer">
    	...
    	<div class="search-toggle" >
            ...
            <div class="col-lg-12 col-sm-4 col-xs-8">
				...
				<div class="legend"> Room <?php echo $i; ?> </div>
                    <div class="guests" style="width: 100%;">
                        <div class="row" >
                            <div class="col-lg-1">
								...
								(18+) </span></span></span>
                                    <select name="search_hotel.rooms[<?php echo $i; ?>].adlts" class="btn btn-default">
                            ...
                            <div class="col-lg-1">
								...
								<span class="primaryLabel">Child (0-17)</span>
                                        <select name="search_hotel.rooms[<?php echo $i; ?>].chlds" id="search_Childrooms<?php echo $i; ?>" class="btn btn-default">
                        ...
                        <div class="row search_childTravelers noneBlock">
                            ...
                            <?php } ?>
                            <div id="search_ChildLabel1Room<?php echo $i; ?>" style="padding:5px 0px 0px 5px; margin-left: 10px" class="col-lg-1 control select noneInlineBlock custom js-select">
                                <span class="primaryLabel offscreen"><span class="labelText">Child 1</span></span>
                                <select name="search_hotel.rooms[<?php echo $i; ?>].chldAge[0]" class="btn btn-default">
                                    <option value="">--</option>
                            ...
                            <div id="search_ChildLabel2Room<?php echo $i; ?>" style="padding:5px 0px 0px 5px;" class="col-lg-1 control select noneInlineBlock custom js-select">
                                <span class="primaryLabel offscreen"><span class="labelText">Child 2</span></span>
                                <select name="search_hotel.rooms[<?php echo $i; ?>].chldAge[1]" class="btn btn-default">
                                    <option value="">--</option>
                                    <option value="00">&lt; 1</option>
                                    <?php $v2466138002iterator = range(1, 17); $v2466138002incr = 0; $v2466138002loop = new stdClass(); $v2466138002loop->length = count($v2466138002iterator); $v2466138002loop->index = 1; $v2466138002loop->index0 = 1; $v2466138002loop->revindex = $v2466138002loop->length; $v2466138002loop->revindex0 = $v2466138002loop->length - 1; ?><?php foreach ($v2466138002iterator as $j) { ?><?php $v2466138002loop->first = ($v2466138002incr == 0); $v2466138002loop->index = $v2466138002incr + 1; $v2466138002loop->index0 = $v2466138002incr; $v2466138002loop->revindex = $v2466138002loop->length - $v2466138002incr; $v2466138002loop->revindex0 = $v2466138002loop->length - ($v2466138002incr + 1); $v2466138002loop->last = ($v2466138002incr == ($v2466138002loop->length - 1)); ?>
                                        <option value="<?php echo $j; ?>"><?php echo $j; ?></option>
                            ...
                            <div id="search_ChildLabel3Room<?php echo $i; ?>"  style="padding:5px 0px 0px 5px;" class="col-lg-1 control select noneInlineBlock custom js-select">
                                <span class="primaryLabel offscreen"><span class="labelText">Child 3</span></span>
                                <select name="search_hotel.rooms[<?php echo $i; ?>].chldAge[2]" class="btn btn-default">
                                    <option value="">--</option>
                                    <option value="00">&lt; 1</option>
                                    <?php $v2466138002iterator = range(1, 17); $v2466138002incr = 0; $v2466138002loop = new stdClass(); $v2466138002loop->length = count($v2466138002iterator); $v2466138002loop->index = 1; $v2466138002loop->index0 = 1; $v2466138002loop->revindex = $v2466138002loop->length; $v2466138002loop->revindex0 = $v2466138002loop->length - 1; ?><?php foreach ($v2466138002iterator as $j) { ?><?php $v2466138002loop->first = ($v2466138002incr == 0); $v2466138002loop->index = $v2466138002incr + 1; $v2466138002loop->index0 = $v2466138002incr; $v2466138002loop->revindex = $v2466138002loop->length - $v2466138002incr; $v2466138002loop->revindex0 = $v2466138002loop->length - ($v2466138002incr + 1); $v2466138002loop->last = ($v2466138002incr == ($v2466138002loop->length - 1)); ?>
                                        <option value="<?php echo $j; ?>"><?php echo $j; ?></option>
                            ...
                            <div id="search_ChildLabel4Room<?php echo $i; ?>" style="padding:5px 0px 0px 5px;" class="col-lg-1 control select noneInlineBlock custom js-select">
                                <span class="primaryLabel offscreen"><span class="labelText">Child 4</span></span>
                                <select name="search_hotel.rooms[<?php echo $i; ?>].chldAge[3]" class="btn btn-default">
                                    <option value="">--</option>
                                    <option value="00">&lt; 1</option>
                                    <?php $v2466138002iterator = range(1, 17); $v2466138002incr = 0; $v2466138002loop = new stdClass(); $v2466138002loop->length = count($v2466138002iterator); $v2466138002loop->index = 1; $v2466138002loop->index0 = 1; $v2466138002loop->revindex = $v2466138002loop->length; $v2466138002loop->revindex0 = $v2466138002loop->length - 1; ?><?php foreach ($v2466138002iterator as $j) { ?><?php $v2466138002loop->first = ($v2466138002incr == 0); $v2466138002loop->index = $v2466138002incr + 1; $v2466138002loop->index0 = $v2466138002incr; $v2466138002loop->revindex = $v2466138002loop->length - $v2466138002incr; $v2466138002loop->revindex0 = $v2466138002loop->length - ($v2466138002incr + 1); $v2466138002loop->last = ($v2466138002incr == ($v2466138002loop->length - 1)); ?>
                                        <option value="<?php echo $j; ?>"><?php echo $j; ?></option>
                            ...
                            <div id="search_ChildLabel5Room<?php echo $i; ?>" style="padding:5px 0px 0px 5px;" class="col-lg-1 control select noneInlineBlock custom js-select">
                                <span class="primaryLabel offscreen"><span class="labelText">Child 5</span></span>
                                <select name="search_hotel.rooms[<?php echo $i; ?>].chldAge[4]" class="btn btn-default">
                                    <option value="">--</option>
                                    <option value="00">&lt; 1</option>
                                    <?php $v2466138002iterator = range(1, 17); $v2466138002incr = 0; $v2466138002loop = new stdClass(); $v2466138002loop->length = count($v2466138002iterator); $v2466138002loop->index = 1; $v2466138002loop->index0 = 1; $v2466138002loop->revindex = $v2466138002loop->length; $v2466138002loop->revindex0 = $v2466138002loop->length - 1; ?><?php foreach ($v2466138002iterator as $j) { ?><?php $v2466138002loop->first = ($v2466138002incr == 0); $v2466138002loop->index = $v2466138002incr + 1; $v2466138002loop->index0 = $v2466138002incr; $v2466138002loop->revindex = $v2466138002loop->length - $v2466138002incr; $v2466138002loop->revindex0 = $v2466138002loop->length - ($v2466138002incr + 1); $v2466138002loop->last = ($v2466138002incr == ($v2466138002loop->length - 1)); ?>
                                        <option value="<?php echo $j; ?>"><?php echo $j; ?></option>
                                ...
                                <span class="button" style=""><span>--</span><div></div></span></div>
                            <?php if ($i == '1') { ?>
                        </div><div class="row" style="padding:28px 0px 0px 22px;"><ul id="search_addRemove<?php echo $i; ?>" class="pipedList addRemove">
