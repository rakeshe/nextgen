...
<!-- Hotel List -->
	...
	<div id="hotel_gold_card_block" class="hd-main-info">
		<div class="row row_nomargin">
			<div class="world_best_deals  col-xs-4 col-sm-4  col-md-4 col-lg-4 pull-left">{{t._('recommended_deals')}}</div>
			<div class="hotel_all_search  col-xs-6 col-sm-6  col-md-7 col-lg-7 pull-right">
                <span class="search_input_hotel">
                    <span class="magnifyGls"></span>&nbsp;{{t._('search_all_hotelclub')}}
                    <b class="caret"></b>
                </span>
		</div>
	</div>
	...
	<div class="search_footer">
		<div class="search_footer_head">
			<span class="search_not_found">{{t._("not_found_what_youre_looking_for")}}</span>
		...
		<div class="input-group">
	      <input type="text" class="form-control" placeholder="{{t._('search_all_hotelclub')}}" id="locationText">
    	...
    	<div class="search-toggle" >
	    	<div class="row" style="padding:1.5%;">
			   ...
			   <div class="col-lg-3 col-sm-4 col-xs-8">
		        	...
		        	<input type="text" class="input-sm" name="" id="proCode" placeholder="{{t._('coupon_code')}}..." value="{% if coupon['code'] is defined %}{{ coupon['code'] }}{% endif %}">
		    	</div>
                    ...
                    <div class="guests col-lg-11 col-md-11 col-xs-9 col-sm-8">
                        ...
                        <div class="row search_childTravelers noneBlock">
                            ...
                            <div id="search_ChildLabel1Room{{ i }}" class="col-xs-2 col-lg-1 control select noneInlineBlock custom js-select search_ChildLabelRoom ">
                                <span class="primaryLabel offscreen"><span class="labelText">{{ t._('child') }} 1</span></span>
                            ...
                            <div id="search_ChildLabel2Room{{ i }}" class="col-xs-2 col-lg-1 control select noneInlineBlock custom js-select search_ChildLabelRoom ">
                                <span class="primaryLabel offscreen"><span class="labelText">{{ t._('child') }} 2</span></span>
                            ...
                            <div id="search_ChildLabel3Room{{ i }}" class="col-xs-2 col-lg-1 control select noneInlineBlock custom js-select search_ChildLabelRoom ">
                                <span class="primaryLabel offscreen"><span class="labelText">{{ t._('child') }} 3</span></span>
                            ...
                            <div id="search_ChildLabel4Room{{ i }}" class="col-xs-2 col-lg-1 control select noneInlineBlock custom js-select search_ChildLabelRoom ">
                                <span class="primaryLabel offscreen"><span class="labelText">{{ t._('child') }} 4</span></span>
                            ...
                            <div id="search_ChildLabel5Room{{ i }}" class="col-xs-2 col-lg-1 control select noneInlineBlock custom js-select search_ChildLabelRoom ">
                                <span class="primaryLabel offscreen"><span class="labelText">{{ t._('child') }} 5</span></span>
                            ...
                            <li><a id="search_add_room{{ i }}" class="link search_addRoom">{{ t._('add_a_room') }}</a></li>
                        </ul></div></div>
						{% elseif  i == "4" %}
                        </div><div class="row" style="padding:28px 0px 0px 0px;"><ul id="search_addRemove{{ i }}" class="pipedList addRemove search_addRemove ">
		...
		<div class="row search_buttons">
			...
			<div class="microcontentBeakLeft" style="left: 0px; top: 8px;"></div>
                <div class="close-btn"><a href="" class="close_dialog" role="">{{ t._('close') }}</a></div>
							...
							<fieldset id="visible_room{{ i }}" data-context="hotelGuests" class="hotelGuests first">
								...
								<span class="primaryLabel"><span class="labelText">{{ t._('child') }} <span class="secondaryText supplementaryMessage">
...
{% if  i == "1" %}
								...
								<li><a id="add_room{{ i }}" class="link addRoom">{{ t._('add_a_room') }}</a></li>
								</ul></div>
								{% elseif  i == "4" %}
</div><ul id="addRemove{{ i }}" class="pipedList addRemove">
