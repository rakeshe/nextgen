var eventData = [
        ...
        events: [
            {
                ...
                photos: [
                    {
                        min: 'img/events/jan/westnewyear_min.jpg',
                        full: 'img/events/jan/westnewyear_big.jpg'
                    }
                ]
            },
            {
                ...
                date: '12th - 15th January 2015',
                price: 'HK$100',
                text: 'Describing itself as “Asia’s biggest toys event”, the Hong Kong Toys and Games Fair is the sort of thing exhibitors dream about. Featuring nearly 2,000 exhibitors and over 41,000 buyers from 121 countries, the fair is the place for traders looking to gain wider exposure or simply network within a blooming Asian marketplace. Please note that this event is solely for traders/buyers only and members of the general public will not be admitted. <br /><br />Admission fee is HK$100 per person, with no concessions available. Under-18s will not be admitted. ',
                link: '',
                map: {
                    'long': 22.281286,
                    'lat': 114.1615709
                ...
                photos: [
                    {
                        min: 'img/events/jan/toys_min.jpg',
                        full: 'img/events/jan/toys_big.jpg'
                    }
                ]
            },
            {
                id: 3,
                name: 'Hello, Dolly! The Musical',
                date: '17th - 25th January 2015',
                price: 'HK$140 - HK$420',
                text: 'The classic Broadway musical finally makes it to Hong Kong, in a Cantonese-speaking production (with English subtitles) courtesy of the Hong Kong Repertory Theatre. A jolly romp through the life of a money-obsessed matchmaker who comes to realise there’s more to life (and love) than a hefty bank balance, this “musical comedy dream” has been winning plaudits round the globe ever since it first took to the stage. This new production promises sumptuous costumes, foot-stomping songs and a brand new twist on Dolly courtesy of actress Mimi Lo. <br /><br />Tickets range in price from HK$140 to HK$420. Audio description devices are available in limited numbers from the reception desk and must be reserved in advance. Check the website for more details. ',
                link: 'http://www.hkrep.com/en/events/eng-2014-m7/',
                map: {
                    'long': 22.293557,
                    'lat': 114.172133
                },
                photos: [
                    {
                        min: 'img/events/jan/hellodolly_min.jpg',
                        full: 'img/events/jan/hellodolly_big.jpg'
                    }
                ]
            },
            {
                id: 4,
                name: 'World Boutique Hong Kong',
                date: '19th - 22th January, 2015',
                price: '',
                text: 'Hong Kong likes to consider itself “Asia’s fashion hub” and on the evidence of World Boutique, this claim is entirely justified. A large gathering of brands, models, industry insiders and traders, the expo focuses on everything from prestigious high-class brands to the scrappy young up-and-comers taking on the establishment. Although the expo itself runs for four days, only one of these is open to members of the public: January the 22nd. For those connected with the industry, though, the entire thing is pretty much unmissable. Last year managed to net a total of 650 brands. Expect even more this year. <br /><br />Unusually for an expo, tickets are free, with January 22nd seeing the centre fling its doors open to the masses. However, registration is required: go online to find out more. Please note that under-18s will not be admitted on trade or public days. ',
                link: 'http://www.hktdc.com/fair/worldboutiquehk-en/s/1320-General_Information/HKTDC-World-Boutique-Hong-Kong/Fair-Details.html',
                map: {
                    'long': 22.281286,
                    'lat': 114.1615709
                },
                photos: [
                    {
                        min: 'img/events/jan/boutique_min.jpg',
                        full: 'img/events/jan/boutique_big.jpg'
                    }
                ]
            },
            {
                ...
                date: 'January 19th - 22nd, 2015',
                price: '',
                text: 'A trade fair very much for industry insiders only (there is no admittance to the general public) Hong Kong Fashion Week for Fall/Winter brings together over 1,500 exhibitors and 21,900 buyers from 91 different countries around the world. With an emphasis on professionalism and networking, the fair facilitates those wishing to invest in new products, discover new niches or simply take part in one of the many meetings/seminars that sprout up around the main action like mushrooms. <br /><br />Attendance is free, but solely for those working within the fashion industry. However, you must pre-register to be eligible. Please also note that under-18s will strictly not be admitted. ',
                link: 'http://www.hktdc.com/fair/hkfashionweekfw-en/s/1125-General_Information/HKTDC-Hong-Kong-Fashion-Week-For-Fall-Winter/Fair-Details.html',
                map: {
                    'long': 22.281286,
                    'lat': 114.1615709
                },
            ...
            },
            {
                id: 6,
                name: 'Das Rheingold',
                date: '22nd - 24th January 2015',
                price: 'HK$280 - HK$880',
                text: 'The start of a mammoth undertaking for the HK Philharmonic, Das Rheingold marks the beginning of an attempt to play the entirety of Wagner’s Ring Cycle across four years. A vast opera story following the machinations of the German Gods, the Ring Cycle has long been recognised as one of Wagner’s greatest achievements – as well as one of his most-technically complex works. Resident Music Director Jaap van Zweden will be conducting proceedings, with Matthias Goerne taking the Baritone role and Michelle DeYoung the mezzo-soprano. Running at an uninterrupted 2.5 hours, this stunning production will leave audiences overwhelmed, exhausted and hungry for more. <br /><br />Tickets range in price from HK$280 to HK$880, with Young Audience Scheme members getting a 55% discount (plus 10% off for accompanying adults). Please note that latecomers and children under 6 may not be admitted. ',
                link: '',
                map: {
                    'long': 22.293557,
                    'lat': 114.172133
                ...
                photos: [
                    {
                        min: 'img/events/jan/rheingold_min.jpg',
                        full: 'img/events/jan/rheingold_big.jpg'
                    }
                ]
            },
            {
                id: 7,
                name: 'Know Your Classical Music: Percussion',
                date: '24th - 25th January 2015',
                price: '',
                text: 'Part of the “Learn” series of programmes currently being curated around the city, Know Your Classical Music brings virtuosic percussionist Johannes Fischer into the fold of the HK Sinfonietta for a daring ‘how to’ in creating captivating music. Under the guidance of conductor Yip Wing-sie, Fischer and the Sinfonietta are aiming to charm a whole new generation of music lovers with the magic of percussion. As an oft-neglected form of classical and orchestral music, it’ll be interesting to see if the company can make converts of the two-night audience. But even if the evening falls short of its stated goal, it’ll doubtless be a spectacular night out. <br /><br />Tickets are not yet on sale, and prices are still to be announced. Those interested in attending should check back with the website periodically or email info@hksinfonietta.org. Please note that children under 6 may not be admitted. ',
                link: 'http://www.hksl.org/en/mobile/concert_schedule/concert_details/112#.VEAVbxbTAkZ',
                map: {
                    'long': 22.282285,
                    'lat': 114.161509
                },
                photos: [
                    {
                        min: 'img/events/jan/classical_min.jpg',
                        full: 'img/events/jan/classical_big.jpg'
                    }
                ]
            },
            {
                ...
                photos: [
                    {
                        min: 'img/events/jan/marathon_min.jpg',
                        full: 'img/events/jan/marathon_big.jpg'
                    }
                ]
            },
            {
                ...
                price: 'HK$200 - HK$580',
                text: 'One of the Philippines’ biggest cultural exports, Lea Salonga is justly-renowned for her work in musical theatre and the movies. A veteran of the stage, she’s perhaps best known for starring in Miss Saigon; as well as providing the singing voice for two Disney princesses (Jasmine in Aladdin and Fa Mulan in Mulan). In one of the biggest scoops of the Cultural Centre’s Holiday, Pops & More season, she’s in town for two-nights only to regale Hong Kong with a selection of her greatest hits. Backing will come courtesy of virtuoso conductor Gerard Salonga, in what promises to be a show-stopping evening. <br /><br />Tickets are available from HK$200, with premium seats going for HK$580. Young Audience Scheme members get a 55% discount, with an extra 10% for accompanying adults. Please note that under-6s and latecomers may not be admitted. ',
                link: '',
                map: {
                    'long': 22.293557,
                    'lat': 114.172133
                ...
                photos: [
                    {
                        min: 'img/events/jan/salonga_min.jpg',
                        full: 'img/events/jan/salonga_big.jpg'
                    }
                ]
            },
        ]
    },
    {
        ...
        events: [
            {
                id: 1,
                name: 'Asian Aerospace International Expo and Congress',
                date: '5th - 8th February 2015',
                price: '',
                text: 'A strictly traders-only fair that involves huge, multi-billion dollar deals being signed, the Asian Aerospace International Expo and Congress would probably slip under most people’s radars, were it not for one thing. Every year, those selling the aircraft put on a full aerial display, visible across the city. From low-flying behemoths buzzing the tops of houses in the suburbs to dashing fighter pilots executing breath-taking manoeuvres high up in the sky, HK airspace becomes one colossal display of derring-do. Industry insiders will already have their passes sorted. The rest of us can simply choose a bar or restaurant with a terrace, or make our way to one of HK’s many parks and enjoy the show for free. ',
                link: '',
                map: {
                    'long': 22.293557,
                    'lat': 114.172133
                ...
                photos: [
                    {
                        min: 'img/events/feb/aerospace_min.jpg',
                        full: 'img/events/feb/aerospace_big.jpg'
                    }
                ]
            },
            {
                ...
                photos: [
                    {
                        min: 'img/events/feb/masters_min.jpg',
                        full: 'img/events/feb/masters_big.jpg'
                    }
                ]
            },
            {
                ...
                photos: [
                    {
                        min: 'img/events/feb/newyear_min.jpg',
                        full: 'img/events/feb/newyear_big.jpg'
                    }
                ]
            },
            {
                ...
                photos: [
                    {
                        min: 'img/events/feb/race_min.jpg',
                        full: 'img/events/feb/race_big.jpg'
                    }
                ]
            },
            {
        ...
        events: [
            {
                ...
                date: 'March 2015 (TBC)',
                price: '',
                text: 'For a few days each year, Hong Kong’s Victoria Park is transformed into a colourful floral explosion. Horticulturalists from across the city and international participants from across the globe gather to turn a tiny corner of HK into a slice of heaven. Showcasing blooms from around the world, the show is a must for those with a green thumb, and a very worthwhile way to spend an afternoon for the rest of us as well. The highlights are the fantastically intricate arrangements made for the competition entries and the vibrant landscape displays. However, the photographic displays and student art competitions should not be missed. <br /><br />Details are scarce at the moment, but expect information to be forthcoming soon. Those interested in attending should periodically check back online for more details. ',
            ...
            },
            {
                ...
                photos: [
                    {
                        min: 'img/events/mar/spring_min.jpg',
                        full: 'img/events/mar/spring_big.jpg'
                    }
                ]
            },
            {
                id: 3,
                name: 'Hong Kong Salsa Festival',
                date: '13th - 15th March 2015',
                price: 'HK$1800 - HK$3400 ',
                text: 'When we hear the word “salsa”, how many of us think “Hong Kong”? Well, one visit to HK’s annual salsa festival should change all that. A week-long extravaganza of workshops, parties, performances, outreach programmes and –of course – a championship dance off, the HK salsa festival is one of the biggest in the region; and possibly the best outside of Latin America. Those seriously into this phenomenally popular dance can attend classes, workshops and amateur competitions. Those less willing to don their sequins can attend one of the many excellent performances happening across the region. <br /><br />Tickets vary in price by venue and what’s on offer, although a full-pass for the climactic final weekend is available via the official website. Prices are staggered, with tickets getting more-expensive as time goes on.',
                link: 'http://www.hksalsafestival.com/index.php/en/',
                map: {
                    'long': 22.396428,
                    'lat': 114.109497
                },
                photos: [
                    {
                        min: 'img/events/feb/salsa_min.jpg',
                        full: 'img/events/feb/salsa_big.jpg'
                    }
                ]
            },
            {
                id: 4,
                name: 'BMW Hong Kong Derby',
                date: '15th March 2015',
                price: '',
                text: 'Dating back to 1871, the Hong Kong Derby is a slice of living history; a chance for the breeders and jockeys of the region to come together and show off for the crowds in an event as hotly-contested as it is prestigious. Limited since 1981 to four year old horses only, the Derby is a one-shot chance at glory and international fame, with everything riding on the jockey’s performance. Unsurprisingly, it’s a tense affair, with reputations made and broken in a matter of seconds. <br /><br />Aside from the Derby itself, the day is filled out with the Hong Kong Classic Mile and Hong Kong Classic Cup; another two events open purely to four year olds. If it’s a day at the racetrack that you’re after, the Derby is hard to beat. <br />Detailed information on attendance and the 2015 line-up has yet to be released. Those interested should check back online for further announcements. ',
                link: '',
                map: {
                    'long': 22.400992,
                    'lat': 114.205178
                ...
                photos: [
                    {
                        min: 'img/events/mar/derby_min.jpg',
                        full: 'img/events/mar/derby_big.jpg'
                    }
                ]
            },
            {
            ...
            },
            {
                ...
                price: '',
                text: 'An important date in South Asia’s sports calendar ever since it first started in 1976, the Hong Kong Sevens manages to combine rugby with a carnival-like atmosphere to produce something utterly unique. Over the course of a weekend, teams from 22 countries face-off in a series of super-fast, high-octane seven aside matches, culminating in the battle for the cup. The whole spectacle is ludicrously exciting, and the camaraderie among those in the stands is more-evident than even at the most hotly-contested football match. It’s all in the name of good fun, though, and the festival-like qualities of the weekend make sure any ill-feeling or animosity between supporters is kept firmly in check. <br /><br />Tickets must be purchased through an official travel agent affiliated with the event; for a full list, visit the Sevens’ website. Tickets will be assigned to HK residents through public ballot. Contact the organisers for more information. ',
                link: 'http://www.hksevens.com/eng/tickets/overseas_fans.php',
                map: {
                    'long': 22.272787,
                    'lat': 114.188251
                },
                photos: [
                    {
                        min: 'img/events/mar/sevens_min.jpg',
                        full: 'img/events/mar/sevens_big.jpg'
                    }
                ]
            },
            {
                ...
                photos: [
                    {
                        min: 'img/events/mar/film_min.jpg',
                        full: 'img/events/mar/film_big.jpg'
                    }
                ]
            },
            {
                id: 8,
                name: 'Hong Kong Sinfonietta and Plamena Mangova',
                date: '28th March 2015',
                price: 'HK$150 - HK$380',
                text: 'As part of the 43rd Hong Kong Arts Festival, conductor Yip Wing-Sie is teaming up with legendary Bulgarian pianist Plamena Mangova to whisk us through a catalogue of the greats. The evening starts with the world premiere of Joyce Tang Wai-Chung’s Clear Light; before moving on Tchaikovsky’s Piano Concerto No.1 in B-flat minor, op23; and finishing with Sibelius’s Symphony No5, an extended performance totalling over 2 hours. Music lovers will not want to miss this rare opportunity to witness Ms Mangova in concert. <br /><br />Tickets range from HK$150 to HK$380, with half-price tickets available for students and the over-65s. Please note that this performance is not intended for children under the age of 6, and that they will strictly not be admitted. ',
                link: '',
                map: {
                    'long': 22.272787,
                    'lat': 114.188251
                ...
                photos: [
                    {
                        min: 'img/events/mar/mangova_min.jpg',
                        full: 'img/events/mar/mangova_big.jpg'
                    }
                ]
            }
        ...
        events: [
            {
                ...
                photos: [
                    {
                        min: 'img/events/apr/hungshing_min.jpg',
                        full: 'img/events/apr/hungshing_big.jpg'
                    }
                ]
            },
            {
    ...
    },
    {
        ...
        events: [
            ...
            {
                id: 3,
                name: 'Ani-Com & Games Hong Kong Festival',
                date: 'August 2015 (Exact dates TBC)',
                price: '',
                text: 'Dust off your costumes, break out the hair dye and brush up on your knowledge of animie and manhua: Hong Kong’s annual Ani-Com & Games Festival is back for another year. Bringing together industry insiders, obsessive fans and the general public, this vast expo aims to satisfy the region’s cravings for Japanese animie, Chinese comics (manhua) and international games; with seminars, testing events and plenty of chances to meet writers and designers working in the industry. Similar to Comic Con in the US and Europe, and renowned for attendees spectacular costumes, the Ani-Com and Games Festival is one of the region’s most-enjoyable days out for all those who love to embrace their inner-geek. <br /><br />Ticketing information is currently scarce, and exact dates have yet to be announced. Those interested in attending should periodically check back online for further details. ',
                link: 'http://www.ani-com.hk/',
                map: {
                    'long': 22.282016,
                    'lat': 114.1720093
                },
                photos: [
                    {
                        min: 'img/events/aug/anicom_min.jpg',
                        full: 'img/events/aug/anicom_big.jpg'
                    }
                ]
            },
            {
        ...
        events: [
            {
                ...
                date: 'September 2015 (Exact dates TBC)',
                price: '',
            ...
            {
                id: 2,
                name: 'Hong Kong International Ice Hockey Tournament',
                date: 'September 2015 (Exact dates TBC)',
                price: '',
                text: 'Ice hockey may not be a sport many people associate with Hong Kong, but the country has a thriving amateur league, and the International Ice Hockey Tournament offers the best chance of seeing them in action. Featuring 1,500 players from around the globe in a series of adrenaline-filled playoffs, the tournament is slowly building up a strong local following and even attracting international fans keen for something a little different. Admission last year was free; however this may change soon as the tournament grows more popular. Those who wish to attend should periodically check back online for more details. ',
                link: 'http://www.hkahc.com/',
                map: {
                    'long': 22.3198392,
                    'lat': 114.2081294
                },
                photos: [
                    {
                        min: 'img/events/sep/hockey_min.jpg',
                        full: 'img/events/sep/hockey_big.jpg'
                    },
                    {
                        min: 'img/events/sep/hockey2_min.jpg',
                        full: 'img/events/sep/hockey2_big.jpg'
                    }
                ]
            },
            {
    ...
    },
    {
        ...
        events: [
            ...
            {
                id: 4,
                name: "Freespace Fest 2015",
                date: 'November 2015',
                price: '',
                text: 'Billing itself as Hong Kong’s “most-innovative arts festival”, Freespace is the rebellious baby brother of the HK cultural scene; a spunky up-and-comer taking on the more-established Goliaths. Over the course of a frantic weekend, festival goers can expect to encounter literary gatherings, mobile galleries dedicated to the visual arts, an organic farmers’ market, a silent disco and some of the hottest Asian and international music talent, all crammed into West Kowloon’s pleasing waterfront promenade space. 2014’s edition brought Ellen Loo, Supper Moment and DJ/ Rupture together to spin some tunes among the happy families, and 2015 promises an equally stellar line-up. <br /><br />Those who like to party should make their way to the BYOH (Bring Your Own Headphones) disco. Those with more-sedate tastes should simply turn up in the early afternoon and immerse themselves in the unthreatening atmosphere. Tickets are completely free with no registration required, and families with small children are actively welcomed. ',
                link: '',
                map: {
                    'long': 22.301314,
                    'lat': 114.155178
                ...
                photos: [
                    {
                        min: 'img/events/nov/freespace_min.jpg',
                        full: 'img/events/nov/freespace_big.jpg'
                    }
                ]
            },
            {
            ...
            {
                id: 7,
                name: "Cantonese Opera Day",
                date: 'late November 2015',
                price: '',
                text: 'Despite being almost unheard of in the West, Cantonese Opera is one of Southeast Asia’s greatest cultural exports. Mixing music and singing with traditional martial arts and powerful costumes, it remains essentially unchanged since its creation back in the 13th century. Today, HK’s Leisure and Cultural Services Department is on a mission to introduce this art form to a wider audience, with stunning success. Now in its 13th year, Cantonese Opera Day has become a mainstay of the city’s arts scene, and continues to win over newcomers and clued-up traditionalists alike. <br /><br />Unusually for an event taking place in the Hong Kong Cultural Centre, admission is free and children of all ages are encouraged to attend. Aside from the opera itself, visitors can expect workshops, autograph signing sessions, guided tours and a chance to meet the artists. ',
                link: '',
                map: {
                    'long': 22.294117,
                    'lat': 114.17039
                ...
                photos: [
                    {
                        min: 'img/events/nov/canton_min.jpg',
                        full: 'img/events/nov/canton_big.jpg'
                    }
                ]
            }
        ]
...
var specialEvents = [
    ...
    {
        id: 's15',
        name: '43rd Hong Kong Arts Festival',
        date: '27th February – 29th March 2015',
        price: '',
        text: 'One of the world’s biggest, longest-running city-wide arts festivals, the HK Arts Festival is one of the biggest events on Asia’s cultural calendar. For over a month, venues across the city will fling open their doors to opera, theatre, music and ballet performers from all corners of the globe: mixing top-flight talent with up-and-coming practitioners. Highlights this year include the Dutch National Ballet performing Cinderella, the Los Angeles Philharmonic in concert, legendary jazz artist Bobby McFerrin and the Bolshoi Ballet. For connoisseurs of the performing arts, the entire month promises to be unmissable. <br /><br />Tickets vary in price according to venue and performance, but all must be purchased through the official website. Advance bookings will be accepted until 2nd December, at which point the box office will close. From 13th Dec onwards, tickets will be available at a higher cost through www.urbtix.hk. Please note: advanced ticket sales must be accompanied by a booking form (downloadable through the website). ',
        link: 'https://www.hk.artsfestival.org/en/tickets/index.html',
        map: {
            'long': 22.2824605,
            'lat': 114.1615709
        },
    ...
    },
    {
        ...
        photos: [
            {
                min: 'img/events/mar/interfilm_min.jpg',
                full: 'img/events/mar/interfilm_big.jpg'
            }
        ]
    },
    {
        ...
        date: 'January – February (Exact dates TBC)',
        price: '',
...
//January 2015
eventData[0].events.push(specialEvents[0]);
eventData[0].events.push(specialEvents[12]);
eventData[0].events.push(specialEvents[4]);
eventData[0].events.push(specialEvents[10]);
eventData[0].events.push(specialEvents[3]);
eventData[0].events.push(specialEvents[1]);
eventData[0].events.push(specialEvents[7]);
eventData[0].events.push(specialEvents[13]);
eventData[0].events.push(specialEvents[16]);

//February 2015
eventData[1].events.push(specialEvents[4]);
eventData[1].events.push(specialEvents[10]);
eventData[1].events.push(specialEvents[1]);
eventData[1].events.push(specialEvents[7]);
eventData[1].events.push(specialEvents[0]);
eventData[1].events.push(specialEvents[13]);
eventData[1].events.push(specialEvents[16]);
eventData[1].events.push(specialEvents[14]);

//March 2015
eventData[2].events.push(specialEvents[0]);
eventData[2].events.push(specialEvents[4]);
eventData[2].events.push(specialEvents[7]);
eventData[2].events.push(specialEvents[13]);
eventData[2].events.push(specialEvents[14]);
